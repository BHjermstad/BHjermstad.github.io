...
- [Hyde](#hyde)
  - [Contents](#contents)
  - [Usage](#usage)
    - [Helpful notes / Commands](#helpful-notes--commands)
      - [Local setup](#local-setup)
      - [Sending change to github](#sending-change-to-github)
  - [Options](#options)
...
To start the server locally open a terminal in vscode and run:

```bash
jekyll serve
```

Now your server is running [here](https://127.0.0.1/4000/).

#### Sending change to github

To send changes up to github and make them live:

- Save all the files
- Commit all of the files with vscode
